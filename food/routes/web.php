...
// Shipper
Route::get('/add-shipper','ShipperController@add_shipper');
Route::get('/all-shipper','ShipperController@all_shipper');
Route::post('/save-shipper','ShipperController@save_shipper');
Route::post('/update-shipper/{shipper_id}','ShipperController@update_shipper');
Route::get('/edit-shipper/{shipper_id}','ShipperController@edit_shipper');
Route::get('/delete-shipper/{shipper_id}','ShipperController@delete_shipper');
